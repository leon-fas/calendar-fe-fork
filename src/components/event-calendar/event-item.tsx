...
function EventWrapper({
  ...
  // Get room config for border coloring on all-rooms page
  const getRoomBorderColorClass = (roomColor?: string) => {
    if (!roomColor || !isAllRoomsPage) return "";
  ...
  return (
    <button
      className={cn(
        ...
        // Add room color border on all-rooms page
        isAllRoomsPage && "border-l-4",
        getRoomBorderColorClass(event.roomColor),
        className,
      )}
      ...
      >
        {children || (
          <span className="truncate">
            ...
            {event.title}
            {isAllRoomsPage && event.location && (
              <span className="text-[10px] sm:text-[11px] font-normal opacity-60 ml-1">
                @ {event.location}
              </span>
            )}
          </span>
      ...
      >
        {durationMinutes < 45 ? (
          <div className="truncate">
            ...
            {isAllRoomsPage && event.location && (
              <span className="text-[9px] sm:text-[10px] font-normal opacity-60 ml-1">
                @ {event.location}
              </span>
            )}
          </div>
          ...
          <>
            ...
            {isAllRoomsPage && event.location && (
              <span className="mt-auto text-[10px] sm:text-[11px] font-normal opacity-60">
                @ {event.location}
              </span>
            )}
          </>
